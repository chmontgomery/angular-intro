...
(function () {
  ...
  angular.module('newsApp.services', [])
    .factory('dylanService', ['$q', '$http', function ($q, $http) {
      return {
        getQuotes: function (tickers) {
          var deferred = $q.defer();
          $http({
            method: 'GET',
            url: 'http://api.wsj.net/api/dylan/quotes/v2/comp/quote?id=' + tickers + '&needed=CompositeTrading|Financials|BlueGrassChannels&MaxInstrumentMatches=1&ckey=cecc4267a0',
            headers: {
